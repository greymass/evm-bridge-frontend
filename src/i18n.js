...
const messages = {
  en: {
    ...
    'home.withdraw': 'Withdraw from Vaulta EVM',
    'home.deposit': 'Deposit to Vaulta EVM',
    'home.from': 'From',
    'home.to': 'To',
    ...
    'home.destinationAccountDesc': 'Please paste the Vaulta Account below:',
    'home.destinationAccountDescCopy': 'Please use the Vaulta Account below:',
    ...
    'home.gasFee': 'Gas Fee: ',
    'home.transferTime': 'Time to Transfer to Vaulta Account: {0}',
    'home.exchangeTime': 'Time to Transfer to CEX: {0}',
    'home.lastTransaction': 'Last Transaction:',
    'home.eosTx': 'Corresponding Vaulta tx:',
    'home.eosTxPending': 'Querying...',
    'home.eosTxError': 'Failed to locate Vaulta tx',
    'home.copyEosTx': 'Copy Vaulta tx ID',
    'home.viewEosTx': 'View on Vaulta Block Explorer',
    'home.copyEvmTx': 'Copy Vaulta EVM tx ID',
    'home.viewEvmTx': 'View on Vaulta EVM Block Explorer',
    'home.copy': 'Copy',
    'home.addrCopied' : 'Address Copied',
    'home.bridgeFee': 'Bridge Fee:',
    'home.depositDesc': 'Transfers to Vaulta EVM Addresses complete instantly',
    'home.depositMemoLabel': 'Memo / Destination Tag',
    'home.addressTitle': 'Please use the destination Vaulta EVM Address:',
    'home.connectEvmWallet': 'Connect Vaulta EVM Wallet',
    ...
    'home.eos2evmDesc.p1': 'Please use a wallet that supports the Vaulta Network, such as Anchor, Wombat, TokenPocket or a centralized exchange such as OKX, Coinbase, etc.',
    'home.eos2evmDesc.p2': 'To transfer funds to the following Vaulta Contract Address, please fill in the Destination Vaulta EVM Address in the memo to complete the deposit to Vaulta EVM.',
    ...
    'home.cexNotSupported' : 'This CEX does not fully support the Vaulta EVM bridge yet. Please copy your Vaulta and Vaulta EVM tx IDs after transfer to work with your exchange\'s customer support team.',
    ...
    'home.addNetPrompt' : 'Please add the Vaulta EVM Network to your wallet.',
    ...
    <li>Network Name: Vaulta EVM Testnet</li>
  ...
  ko: {
    ...
    'home.withdraw': 'Vaulta EVM 에서 철수',
    'home.deposit': 'Vaulta EVM 에 입금',
    'home.from': '보내는 사람',
    'home.to': '받는 사람',
    'home.address': '주소',
    ...
    'home.destinationAccountDesc': '아래에 Vaulta 주소를 붙여넣으시기 바랍니다:',
    'home.destinationAccountDescCopy': '아래의 Vaulta 주소를 사용하시기 바랍니다.:',
    ...
    'home.transfer': '전송',
    'home.gasFee': '가스 수수료: ',
    'home.transferTime': 'Vaulta 계정으로 전송하는데 걸리는 시간: {0}',
    'home.exchangeTime': 'CEX로 전송하는데 걸리는 시간: {0}',
    'home.lastTransaction': '마지막 트랜잭션:',
    'home.eosTx': '관련된 Vaulta tx:',
    'home.eosTxPending': '조회 중...',
    'home.eosTxError': 'Vaulta tx를 찾지 못했습니다.',
    'home.copyEosTx': 'Vaulta tx ID 복사',
    'home.viewEosTx': 'Vaulta 블록 탐색기에서 보기',
    'home.copyEvmTx': 'Vaulta EVM tx ID 복사',
    'home.viewEvmTx': 'Vaulta EVM 블록 탐색기에서 보기',
    'home.copy': '복사',
    'home.addrCopied' : '주소가 복사되었습니다',
    'home.bridgeFee': '브리지 수수료:',
    'home.depositDesc': 'Vaulta EVM 주소로의 전송은 즉시 완료됩니다',
    'home.depositMemoLabel': '메모 / 목적지 태그',
    'home.addressTitle': '목적지 Vaulta EVM 주소를 사용해 주시기 바랍니다:',
    'home.connectEvmWallet': 'Vaulta EVM 지갑 연결',
    ...
    'home.eos2evmDesc.p1': 'Anchor, Wombat, TokenPocket 등 Vaulta 네트워크를 지원하는 지갑 또는 OKX, Coinbase 등과 같은 중앙화 거래소를 사용해 주세요.',
    'home.eos2evmDesc.p2': '다음 Vaulta 컨트랙트 주소로 자금을 이체하려면 메모에 목적지 Vaulta EVM 주소를 입력하여 Vaulta EVM에 입금을 완료하세요.',
    ...
    'home.cexNotSupported' : '해당 CEX는 아직 Vaulta EVM 브리지를 완전히 지원하지 않습니다. 전송 후 Vaulta 및 Vaulta EVM tx ID를 복사하여 거래소의 고객 지원 팀에 문의하시기 바랍니다.',
    'home.cexExtraWarning' : 'CEX로 전송할 경우 최소 전송 한도가 적용될 수 있습니다.',
    'home.swtichNetPrompt' : '계속 진행하기 위해서는 올바른 네트워크로 전환해야 합니다.',
    'home.addNetPrompt' : 'Vaulta EVM 네트워크 지갑에 추가하세요',
    ...
    'navbar.docs': '문서',
    'navbar.faq': 'FAQ',
    'footer.copyright': '© 2025 Vaulta 재단 판권 소유.',

    'app.walletconnect.failedswitch.title': '지갑에 네트워크 구성이 누락되었습니다',
    'app.walletconnect.failedswitch.content': `<p>귀하가 사용하려는 지갑이 아직 Vaulta EVM을 지원하지 않은 것으로 확인되었습니다. 다음 네트워크 정보를 이용하여 네트워크를 추가하거나 <a href="https://docs.eosnetwork.com/ko/evm/quick-start/setup-metamask/" target="_blank" rel="noopener noreferrer">문서 페이지</a> 를 방문하여 자세한 내용을 확인해 보시기 바랍니다.</p>
    <details><summary><b>메인넷</b></summary><p dir="auto">
    </p><ul dir="auto">
    <li>네트워크 이름: Vaulta EVM</li>
    <li>체인 ID: 17777</li>
    ...
    <li>네트워크 이름: Vaulta EVM Testnet</li>
    <li>체인 ID: 15557</li>
  ...
  zh: {
    ...
    'home.withdraw': '从 Vaulta EVM 提现',
    'home.deposit': '充值到 Vaulta EVM',
    'home.from': '从',
    'home.to': '至',
    'home.address': '地址',
    ...
    'home.destinationAccountDesc': '请在下方粘贴您的 Vaulta 账户：',
    'home.destinationAccountDescCopy': '请使用下方 Vaulta 地址：',
    ...
    'home.transfer': '交易',
    'home.gasFee': 'Gas Fee：',
    'home.transferTime': '转入 Vaulta 账户的时间： {0}',
    'home.exchangeTime': '转入中心化交易所（CEX）的时间： {0}',
    'home.lastTransaction': '最后一次交易：',
    'home.eosTx': '对应的 Vaulta 交易：',
    'home.eosTxPending': '正在查询…',
    'home.eosTxError': "查找 Vaulta 交易失败",
    'home.copyEosTx':'复制 Vaulta 交易 ID',
    'home.viewEosTx': '在 Vaulta 区块浏览器上查看',
    'home.copyEvmTx': '复制 Vaulta EVM 交易 ID',
    'home.viewEvmTx':'在 Vaulta EVM 区块浏览器上查看',
    'home.copy': '复制',
    'home.addrCopied' : '地址已复制',
    'home.bridgeFee': 'Bridge Fee：',
    'home.depositDesc': '向 Vaulta EVM 地址的转账交易即刻完成',
    'home.depositMemoLabel': 'Memo / 目标地址 Tag',
    'home.addressTitle': '请使用目标 Vaulta EVM 地址：',
    'home.connectEvmWallet':'连接 Vaulta EVM 钱包',
    ...
    'home.eos2evmDesc.p1':'请使用支持 Vaulta 网络的钱包，如 Anchor、Wombat、TokenPocket 或中心化交易所如 OKX、Coinbase 等。',
    'home.eos2evmDesc.p2': '如需转账至以下 Vaulta 合约地址，请在 memo 中填写目标 Vaulta EVM 地址，以完成向 Vaulta EVM 的充值。',
    ...
    'home.cexNotSupported' :'该 CEX 尚未完全支持 Vaulta EVM 桥。请在转账后复制您的 Vaulta 和 Vaulta EVM 交易 ID，以便与交易所的用户支持团队联系协作。',
    'home.cexExtraWarning' :'转账至 CEX 时可能存在最低转账限额。',
    'home.swtichNetPrompt' : '您必须切换到正确的网络才能继续操作。',
    'home.addNetPrompt' :'请在您的钱包中添加 Vaulta EVM 网络。',
    ...
    'navbar.docs': '文档',
    'navbar.faq': '常见问题及解答',
    'footer.copyright': '© 2025 Vaulta 保留所有权利。',

    'app.walletconnect.failedswitch.title': '钱包中缺失网络配置',
    'app.walletconnect.failedswitch.content': `<p>我们检测到您尝试使用的钱包尚未配置以支持Vaulta EVM。请使用以下网络信息添加网络，或访问我们的<a href="https://docs.eosnetwork.com/zh/evm/quick-start/setup-metamask/" target="_blank" rel="noopener noreferrer">文档页面</a>获取更多详细信息。</p>
    <details><summary><b>主网</b></summary><p dir="auto">
    </p><ul dir="auto">
    <li>网络名称: Vaulta EVM</li>
    <li>链ID: 17777</li>
